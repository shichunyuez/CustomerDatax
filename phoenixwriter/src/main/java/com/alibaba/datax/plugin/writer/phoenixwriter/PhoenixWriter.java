package com.alibaba.datax.plugin.writer.phoenixwriter;
...
//TODO writeProxy
public class PhoenixWriter extends Writer {
    private static final DataBaseType DATABASE_TYPE = DataBaseType.Phoenix;
