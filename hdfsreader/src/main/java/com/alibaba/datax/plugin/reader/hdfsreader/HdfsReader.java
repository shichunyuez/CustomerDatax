...
public class HdfsReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void validate(){
            ...
            //check hdfs HA conf
            String hdfsHAConf=this.readerOriginConfig.getString(Key.HDFS_HA_CONF);
        ...
        @Override
        public void prepare() {
            LOG.info("prepare(), start to getAllFiles, isRecursive: "+this.readerOriginConfig.getBool(Key.IS_RECURSIVE,false));
            this.sourceFiles = dfsUtil.getAllFiles(path, specifiedFileType,this.readerOriginConfig.getBool(Key.IS_RECURSIVE,false));
        ...
        public List<Configuration> split(int adviceNumber) {
            ...
            if (0 == this.sourceFiles.size()) {
                LOG.warn("目录 "+this.readerOriginConfig.getString(Key.PATH)+" 下没有文件或文件为空,将不发送数据.");
